...
class AllSupLandingPage extends StatelessWidget {
  const AllSupLandingPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BaseView<ProjectDetailsProvider>(
        ...
        appBar: CustomAppBar(
          title: Text("All Support Requests"),
        ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildStatusCard(
                              ...
                              context: context,
                              label: 'Opened',
                              count: provider.projectDetailList.isNotEmpty ? ((provider.projectDetailList.first.openSupCount != null)  ? provider.projectDetailList.first.openSupCount.toString():"") : "",
                            ...
                            _buildStatusCard(
                              ...
                              context: context,
                              label: 'Delayed',
                              count: provider.projectDetailList.isNotEmpty ? ((provider.projectDetailList.first.delaySupCount != null)  ? provider.projectDetailList.first.delaySupCount.toString():"") : "",
                            ...
                            _buildStatusCard(
                                ...
                                context: context,
                                label:  'Closed',
                                count:  provider.projectDetailList.isNotEmpty ? ((provider.projectDetailList.first.closeSupCount != null)  ? provider.projectDetailList.first.closeSupCount.toString():"") : "",
