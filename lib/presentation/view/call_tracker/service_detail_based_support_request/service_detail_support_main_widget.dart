...
class ServiceDetailsSupportRequestMainWidget extends StatelessWidget {
  const ServiceDetailsSupportRequestMainWidget({super.key});
  @override
  Widget build(BuildContext context) {
    return BaseStatelessConsumer<ServiceDetailsSupportRequestProvider>(
                  ...
                  child: RefreshIndicator(
                    ...
                    child: provider.supportRequestFetched
                      ...
                      "There are no ${provider.bottomBarStatus == AllObservationAndSupportStatus.opened ? "opened"
                          ...
                          ? "delayed" : "closed"} ${provider.isFromDashboard ? "support requests for this user" : "service support requests" }",
