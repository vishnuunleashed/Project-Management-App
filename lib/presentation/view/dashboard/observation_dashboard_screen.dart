...
class ObservationDashboardScreen extends ConsumerStatefulWidget {
  final bool hideAppBar;
  final String? forcedTitle;
  final int? projectId;


  const ObservationDashboardScreen({
    super.key,
  ...
  @override
  ConsumerState<ObservationDashboardScreen> createState() => _ObservationDashboardScreenState();
}

class _ObservationDashboardScreenState extends ConsumerState<ObservationDashboardScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return BaseView<DashBoardProvider>(
      appBar: widget.hideAppBar ? null : CustomAppBar(
        title: Text(
          widget.forcedTitle ?? "Observation Dashboard",
        ),
      ),
      initState: (context, provider, ref) {
        ...
        provider.initValues(effectiveProjectId,true,extra);
