...
Future<void> showClientMultiSelectDialog(
  ...
  List<CommonMasterModel> filteredNames = List.from(clientList);
  final TextEditingController searchController = TextEditingController();

  Set<String> selectedNames = Set.from(initiallySelected);

  void filterList(String query) {
    filteredNames = clientList
                          ...
                          children: [
                            _NameTile(
                              ...
                              onSubmit: () {
                                ...
                                setState(() {
                                  if (selectedNames.contains(item.clientname)) {
                            ...
                            Positioned(
                              ...
                              child: Center(
                                child: Checkbox(
                                  value:
                                      selectedNames.contains(item.clientname),
