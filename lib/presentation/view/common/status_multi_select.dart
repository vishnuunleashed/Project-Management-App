...
Future<void> showStatusMultiSelectDialog(
  ...
  List<StatusModel> filteredNames = List.from(statusList);
  final TextEditingController searchController = TextEditingController();

  Set<String> selectedNames = Set.from(initiallySelected);

  void filterList(String query) {
    filteredNames = statusList
        .where((status) => status.description
            .toString()
            .toLowerCase()
                          ...
                          children: [
                            ...
                            Positioned(
                              ...
                              child: Center(
                                child: Checkbox(
                                  value:
                                      selectedNames.contains(item.description),
