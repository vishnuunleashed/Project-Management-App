...
Future<void> showPriorityMultiSelectDialog(
  ...
  List<CommonMasterModel> filteredNames = List.from(priorityList);
  final TextEditingController searchController = TextEditingController();

  Set<String> selectedNames = Set.from(initiallySelected);

  void filterList(String query) {
    filteredNames = priorityList
        .where((priority) => priority.description
        .toString()
        .toLowerCase()
                          ...
                          children: [
                            _NameTile(
                              ...
                              onSubmit: () {
                                ...
                                setState(() {
                                  if (selectedNames.contains(item.description)) {
                                    selectedNames.remove(item.description);
                                  } else {
                                    selectedNames.add(item.description);
                                  }
                                });
                              },
                            ),
                            ...
                            Positioned(
                              ...
                              child: Center(
                                child: Checkbox(
                                  value: selectedNames.contains(item.description),
