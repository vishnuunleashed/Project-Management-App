...
Future<void> commonMasterListDialog(
    BuildContext context, {
      required List<CommonMasterModel> master,
      required void Function(CommonMasterModel) onForward,
      String title = 'Schedule Type',
    }) {
  List<CommonMasterModel> filteredTask = List.from(master);
