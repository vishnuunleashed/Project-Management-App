...
Future<void> showEngineerMultiSelectDialog(
  BuildContext context, {
  required List<EngineerModel> engineerList,
  required void Function(List<String> names) onForward,
  required List<String> initiallySelected,
  String title = 'Engineer',
}) {
  List<EngineerModel> filteredNames = List.from(engineerList);
  final TextEditingController searchController = TextEditingController();

  Set<String> selectedNames = Set.from(initiallySelected);

  void filterList(String query) {
    filteredNames = engineerList
        .where((engineer) => engineer.name
            .toString()
            .toLowerCase()
