...
class SupportRequestsCard extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SupportRequestsCard> createState() =>
      _SupportRequestsCardState();
}

class _SupportRequestsCardState extends ConsumerState<SupportRequestsCard> {
  ...
  void initState() {
    super.initState();
    _currentPage = ref.read(projectDashboardProvider).supportCurrentPage;
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                child: Text(
                  "${provider.supportReqCount?.totalCount ?? "0"}",
      ...
      AnimatedCrossFade(
              ...
              AnimatedContainer(
                ...
                child: PageView.builder(
                  ...
                  onPageChanged: (index) {
                    ...
                    provider.updateSupportPage(index);
                  ...
                  itemBuilder: (context, index) {
                    return ProjectTile(
                      ...
                      index: index,
                      toolTipAdd: "Add Support Requests",
                      toolTipAll: "All Support Requests",
                      ...
                      onSubCountTap: (statusTitle, isDelayed) {
                        GoRouter.of(context)
                          ...
                          "flagSupport": provider.categoryFlag.name,
                          "subStatus":
                              statusTitle, // added for filtering later
                          "userId": provider.userId
                        });
                      },
                      isObservation: false,
        ...
        crossFadeState: provider.isExpandedSupport
