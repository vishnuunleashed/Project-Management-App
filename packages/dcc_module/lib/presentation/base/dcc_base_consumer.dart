...
class DccBaseConsumer<U extends DccBaseProvider> extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DccBaseConsumer<U>> createState() => _DccBaseConsumerState();
}

class _DccBaseConsumerState<U extends DccBaseProvider>
    extends ConsumerState<DccBaseConsumer<U>> {
  @override
  void initState() {
    super.initState();
